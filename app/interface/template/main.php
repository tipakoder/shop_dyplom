...
<head>
    ...
    <link rel="stylesheet" href="/app/interface/res/css/fontawesome.min.css">
    <link rel="stylesheet" href="/app/interface/res/css/fonts.css">
    <link rel="stylesheet" href="/app/interface/res/css/animation.css">
    <link rel="stylesheet" href="/app/interface/res/css/popup.css">
    <link rel="stylesheet" href="/app/interface/res/css/main.css">
    <link rel="stylesheet" href="/app/interface/res/css/adaptive.css">
    <link rel="stylesheet" href="/app/interface/res/css/template.css">
...
<body>
    ...
    <script src="/app/interface/res/js/popup.js"></script>
    <script src="/app/interface/res/js/search.js"></script>
    <script src="/app/interface/res/js/main.js"></script>
    <script src="/app/interface/res/js/product.js"></script>
    <?php if($AUTH){ ?>
        <script src="/app/interface/res/js/user.js"></script>
    <?php } ?>
    <?php if($SYS_LEVELACCESS == 0){ ?>
        <script src="/app/interface/res/js/admin.js"></script>
    <?php } ?>
